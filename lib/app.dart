...
import 'package:incodegroup_test/localization/localization_wrapper.dart';
import 'package:incodegroup_test/logic/bloc/bloc.dart';
import 'package:incodegroup_test/logic/injection/injection.dart';
import 'package:incodegroup_test/logic/navigation/app_navigation.dart';
import 'package:incodegroup_test/logic/services/services.dart';
...
class _AppState extends State<App> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider<CharacterBloc>(create: (_) => getIt<CharacterBloc>()),
      ],
